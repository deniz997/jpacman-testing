...
This code has been developed and is used at a software testing course at Delft University of Technology, The Netherlands. Teachers interested in seeing the exercises I use there are invited to contact Arie van Deursen.

Other universities who have used this material include Antwerp, Mons, Eindhoven, Magdeburg and UBC (Vancouver).
At TU Delft, is is used in combination with GitLab as continuous integration and feedback server.
